...
class NarberalGamma:
    ...
    def handle_for(self, i, code):
        ...
        # util.get_position_before_item(substring, "}")
        # j
        # j - 1
        ...
        self.depth_for += 1
        self.graph.append(GraphView(type="for", keywords={"predicate": parsed_predicate, "depth": self.depth_for}))
    ...
    def handle_cycle_predicate(self, predicate) -> dict:
        ...
        # @TODO обработать for (int var = someth;...)
